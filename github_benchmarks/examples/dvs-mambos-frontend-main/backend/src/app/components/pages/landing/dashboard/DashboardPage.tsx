                                          ...
                                          <div className="row g-3 mb-0 align-items-center">
                                              ...
                                              <div className="col-auto">
                                                  <button type="button" className="btn btn-soft-success shadow-none">
                                                      <i className="ri-add-circle-line align-middle me-1" /> Add
                                                      Product
                                                  </button>
                                              </div>
                                              {/*   end col   */}
                                              <div className="col-auto">
                                                  <button type="button"
                                                      ...
                                                      <i className="ri-pulse-line" /></button>
                                              </div>
                                              {/*   end col   */}
                                          </div>
                                          {/*   end row   */}
                                          ...
                                          <div className="dropdown card-header-dropdown">
                                              <a className="text-reset dropdown-btn" href="#"
                                                 ...
                                                 aria-expanded="false">
                                                  ...
                                                  className="mdi mdi-chevron-down ms-1" /></span>
                                              </a>
                                      ...
                                      <div className="acitivity-item py-3 d-flex">
                                          ...
                                          <div className="flex-grow-1 ms-3">
                                              ...
                                              <p className="text-muted mb-0">Flash sale by <a
                                                  href="#." className="link-secondary fw-medium">Zoetic
                                                  Fashion</a></p>
                                      ...
                                      <div className="acitivity-item py-3 d-flex">
                                          ...
                                          <div className="flex-grow-1 ms-3">
                                              ...
                                              <p className="text-muted mb-2"><span
                                                  ...
                                                  submit the monthly sales report. <a href="#."
