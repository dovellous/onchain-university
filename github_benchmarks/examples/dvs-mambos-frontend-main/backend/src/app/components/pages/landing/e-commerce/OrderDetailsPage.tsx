...
const OrderDetailsPage:React.FunctionComponent<PageProps> = ({ children, ...props}) : any | null => {
          ...
          <div className="row">
                      ...
                      <div className="card-header">
                          <div className="d-flex align-items-center">
                              ...
                              <div className="flex-shrink-0">
                                  <a href="apps-invoices-details.html" className="btn btn-success btn-sm"><i
                                      className="ri-download-2-fill align-middle me-1"></i> Invoice</a>
                              </div>
                          </div>
                      </div>
                                      ...
                                      <td>
                                          <div className="d-flex">
                                              ...
                                              <div className="flex-grow-1 ms-3">
                                                  <h5 className="fs-15"><a href="apps-ecommerce-product-details.html"
                                                                           className="link-primary">Sweatshirt for Men
                                                      (Pink)</a></h5>
                                                  <p className="text-muted mb-0">Color: <span
                                                      className="fw-medium">Pink</span></p>
                                                  <p className="text-muted mb-0">Size: <span
                                                      className="fw-medium">M</span></p>
                                              </div>
                                          </div>
                                      </td>
                                      <td>$119.99</td>
                                  ...
                                  <tr>
                                      <td>
                                          <div className="d-flex">
                                              ...
                                              <div className="flex-grow-1 ms-3">
                                                  <h5 className="fs-15"><a href="apps-ecommerce-product-details.html"
                                                                           className="link-primary">Noise NoiseFit
                                                      Endure Smart Watch</a></h5>
                                                  <p className="text-muted mb-0">Color: <span
                                                      className="fw-medium">Black</span></p>
                                                  <p className="text-muted mb-0">Size: <span
                                                      className="fw-medium">32.5mm</span></p>
                                              </div>
                                          </div>
                                      </td>
                                      <td>$94.99</td>
                                  ...
                                  <tr>
                                      <td>
                                          <div className="d-flex">
                                              ...
                                              <div className="flex-grow-1 ms-3">
                                                  <h5 className="fs-15"><a href="apps-ecommerce-product-details.html"
                                                                           className="link-primary">350 ml Glass Grocery
                                                      Container</a></h5>
                                                  <p className="text-muted mb-0">Color: <span
                                                      className="fw-medium">White</span></p>
                                                  <p className="text-muted mb-0">Size: <span className="fw-medium">350 ml</span>
                                                  </p>
                                              </div>
                                          </div>
                                      </td>
                                      ...
                                      <td>
                                          <div className="text-warning fs-15">
                                              <i className="ri-star-fill"></i><i className="ri-star-fill"></i><i
                                              className="ri-star-half-fill"></i><i className="ri-star-line"></i><i
                          ...
                          <div className="d-sm-flex align-items-center">
                              ...
                              <div className="flex-shrink-0 mt-2 mt-sm-0">
                                  <a href="javasccript:void(0;)"
                                     className="btn btn-soft-info btn-sm mt-2 mt-sm-0 shadow-none"><i
                                      className="ri-map-pin-line align-middle me-1"></i> Change Address</a>
                                  <a href="javasccript:void(0;)"
                                     className="btn btn-soft-danger btn-sm mt-2 mt-sm-0 shadow-none"><i
                                      className="mdi mdi-archive-remove-outline align-middle me-1"></i> Cancel Order</a>
                              </div>
                          </div>
                      </div>
                      <div className="card-body">
                                             ...
                                             href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                              <div className="d-flex align-items-center">
                                                  <div className="flex-shrink-0 avatar-xs">
                                                      <div className="avatar-title bg-success rounded-circle shadow">
                                                          <i className="ri-shopping-bag-line"></i>
                                                      </div>
                                                  </div>
                                                  <div className="flex-grow-1 ms-3">
                                                      <h6 className="fs-15 mb-0 fw-semibold">Order Placed - <span
                                                          className="fw-normal">Wed, 15 Dec 2021</span></h6>
                                                  </div>
                                              </div>
                                          </a>
                                      </div>
                                          ...
                                          <a className="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                             href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                              <div className="d-flex align-items-center">
                                                  ...
                                                  <div className="flex-grow-1 ms-3">
                                                      <h6 className="fs-15 mb-1 fw-semibold">Packed - <span
                                                          className="fw-normal">Thu, 16 Dec 2021</span></h6>
                                                  </div>
                                              </div>
                                          </a>
                                      </div>
                                          ...
                                          <a className="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                             href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                              <div className="d-flex align-items-center">
                                                  ...
                                                  <div className="flex-grow-1 ms-3">
                                                      <h6 className="fs-15 mb-1 fw-semibold">Shipping - <span
                                                          className="fw-normal">Thu, 16 Dec 2021</span></h6>
                                                  </div>
                                              </div>
                                          </a>
              ...
              <div className="col-xl-3">
                  <div className="card">
                      <div className="card-header">
                          <div className="d-flex">
                              <h5 className="card-title flex-grow-1 mb-0"><i
                                  className="mdi mdi-truck-fast-outline align-middle me-1 text-muted"></i> Logistics
                                  Details</h5>
                              <div className="flex-shrink-0">
                                  <a href="javascript:void(0);" className="badge badge-soft-primary fs-11">Track
                                      Order</a>
                              </div>
                          </div>
                      </div>
                  ...
                  <div className="card">
                      ...
                      <div className="card-body">
                          <ul className="list-unstyled mb-0 vstack gap-3">
                              ...
                              <li><i className="ri-mail-line me-2 align-middle text-muted fs-16"></i>josephparker@gmail.com
                              </li>
                              <li><i className="ri-phone-line me-2 align-middle text-muted fs-16"></i>+(256) 245451 441
                              </li>
                          </ul>
                      </div>
                  </div>
                  ...
                  <div className="card">
                      <div className="card-header">
                          <h5 className="card-title mb-0"><i
                              className="ri-map-pin-line align-middle me-1 text-muted"></i> Billing Address</h5>
                      </div>
                      <div className="card-body">
                  ...
                  <div className="card">
                      <div className="card-header">
                          <h5 className="card-title mb-0"><i
                              className="ri-map-pin-line align-middle me-1 text-muted"></i> Shipping Address</h5>
                      </div>
                      <div className="card-body">
                          <ul className="list-unstyled vstack gap-2 fs-13 mb-0">
                              <li className="fw-medium fs-14">Joseph Parker</li>
                  ...
                  <div className="card">
                      <div className="card-header">
                          <h5 className="card-title mb-0"><i
                              className="ri-secure-payment-line align-bottom me-1 text-muted"></i> Payment Details</h5>
                      </div>
                      <div className="card-body">
